...
//+kubebuilder:rbac:groups=demo.demo,resources=demovolumes,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=demo.demo,resources=demovolumes/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=demo.demo,resources=demovolumes/finalizers,verbs=update
